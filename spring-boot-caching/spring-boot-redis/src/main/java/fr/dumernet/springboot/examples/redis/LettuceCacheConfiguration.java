...
@EnableCaching
@Slf4j
public class LettuceCacheConfiguration {
    ...
    @Bean
    public RedisConnectionFactory redisConnectionFactory(CacheConfigurationProperties properties) {
    ...
    public CacheManager cacheManager(RedisConnectionFactory redisConnectionFactory, CacheConfigurationProperties properties) {
        ...
        RedisCacheConfiguration defaultCacheConfiguration = cacheConfiguration(properties);
